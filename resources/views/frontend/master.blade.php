...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="logo">
            <h1><a href="index.html">Hasan</a></h1>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-xl-7 ps-0 ps-lg-5 pe-lg-1 d-flex align-items-stretch">
                    <div class="content d-flex flex-column justify-content-center">
                        <h3>These is Md. Razib Hasan</h3>
                        <p>
                            Well organized, creative and a strong problem solver with outstanding organizational, analytical
                        ...
                        <div class="row">
                            <div class="col-md-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Happy Clients</strong> different countries and different working experiences with different business logices.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Projects</strong> working with different types of software and websites.like SCF, POS software and also e-commerce and website. </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Years of experience</strong> worked with different types of technology like php, laravel, codeigniter , JS and also so on.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 d-md-flex align-items-md-stretch">
                                <div class="count-box">
                                    ...
                                    <p><strong>Awards</strong> proudly say, i got different types of awards in my academice and career session.</p>
                                </div>
                            </div>
                        </div>
                    </div><!-- End .content-->
    ...
    <section id="skills" class="skills section-bg">
        <div class="container">
            ...
            <div class="section-title">
                <h2>Skills</h2>
                <p>
                    Excellent planning skills in setting and achieving goals, including
                    meeting tight deadlines. High intellectual capacity to learn, retain and apply new concepts of
                    varying complexity. Cooperative and helpful team participant, with ability to think and work well
                    independently. Systematic, logical thinker, able to compartmentalize program aspects and build
                    integrative systems.
                </p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="resume-item">
                        ...
                        <p><em>B.sc Engineerning in Computer Science - CGPA 3.58 (Out of 4.00)</em></p>
                        <h5>2014 - 2018</h5>
                        <p><em>Bangladesh University of Business and Technology or BUBT is a private university in Bangladesh, located in Mirpur, Dhaka, Bangladesh. The university was established under the Private University Act 1992. BUBT is regulated by the Bangladesh University Grants Commission.</em></p>
                        <p>
                        <ul>
                            <li>Plot # 77-78, Road # 9, Rupnagar R/A Mirpur-2 Dhaka, Dhaka 1216</li>
                            <li>01810-033733</li>
                            <li>bubt.edu.bd</li>
                        </ul>
                        </p>
                    ...
                    <div class="resume-item">
                        <h4>Govt. Devendra College, Manik Ganj</h4>
                        <p><em>Higher Secondary School Certificate - GPA 5.0 (Out of 5.00)</em></p>
                        <h5>2010 - 2012</h5>
                        <p><em></em></p>
                        <p>
                        <ul>
                            <li>Dhaka Board, Dhaka 1216</li>
                    ...
                    <div class="resume-item">
                        <h4>Manik Ganj Govt High School</h4>
                        <p><em>Secondary School Certificate - GPA 5.0 (Out of 5.00)</em></p>
                        <h5>2005 - 2010</h5>
                        <p><em></em></p>
                        <p>
                        <ul>
                    ...
                    <div class="resume-item">
                        ...
                        <p>
                        <ul>
                            <li>3rd Floor, BDBL Bhaban, East 12, Dhaka 1215</li>
                            <li>09612-342486</li>
                        </ul>
                        </p>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="resume-item">
                        ...
                        <p><em>Veefin Sloutions Limited</em></p>
                        <h5>2022 - Present</h5>
                        <p><em>House-15, Road-06, Block-E
                                Flat-A8, Banasree, Rampura, Dhaka-1219
                                Bangladesh</em></p>
                        <p>
                        <ul>
                    ...
                    <div class="resume-item">
                        ...
                        <p><em>Cobait Bangladesh Limited</em></p>
                        <h5>2022 - Present</h5>
                        <p><em>House-15, Road-06, Block-E
                                Flat-A8, Banasree, Rampura, Dhaka-1219
                                Bangladesh</em></p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Software Testing</a></h4>
        ...
        <div class="container">
            ...
            <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
                <div class="swiper-wrapper">
                    @foreach($testimonial_infos as $item)
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            ...
                            <img src="{{ $item->photo }}" class="testimonial-img" alt="{{ $item->name }}" style="height: 90px; width: 90px;">
                            <h3>{{ $item->name }}</h3>
...
<footer id="footer">
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong><span>Hasan</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
